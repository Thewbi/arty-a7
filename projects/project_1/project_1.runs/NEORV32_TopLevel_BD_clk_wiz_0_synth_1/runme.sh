...
HD_PWD='C:/Users/lapto/dev/fpga/arty-a7/projects/project_1/project_1.runs/NEORV32_TopLevel_BD_clk_wiz_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NEORV32_TopLevel_BD_clk_wiz_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NEORV32_TopLevel_BD_clk_wiz_0.tcl
