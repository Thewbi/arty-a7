...
HD_PWD='C:/Users/lapto/dev/fpga/arty-a7/projects/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NEORV32_TopLevel_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NEORV32_TopLevel_BD_wrapper.tcl -notrace
